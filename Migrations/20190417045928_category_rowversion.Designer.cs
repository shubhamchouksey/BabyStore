...
namespace BabyStore.Migrations
{
    ...
    [Migration("20190417045928_category_rowversion")]
    partial class category_rowversion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BabyStore.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BabyStore.Models.Address", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BabyStore.Data.ApplicationUser", b =>
                {
                    b.HasOne("BabyStore.Models.Address", "Address")
                        .WithOne("ApplicationUser")
                        .HasForeignKey("BabyStore.Data.ApplicationUser", "UserRef")
            ...
            modelBuilder.Entity("BabyStore.Models.Order", b =>
                {
                    b.HasOne("BabyStore.Models.Address", "DeliveryAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BabyStore.Data.ApplicationUser")
                        .WithMany()
